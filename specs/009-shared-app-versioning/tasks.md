...
- [ ] **T-001: Scaffold the `@europa/version` package**
...
- [ ] **T-002: Pure drift-checker function + unit tests**
...
- [ ] **T-003: Additive `appVersion` on `HelloAckPayload` (wire change)**
...
- [ ] **[P] T-004: `GET /version` endpoint on the host static surface**
...
- [ ] **[P] T-005: HUD version footer (console)**
...
- [ ] **[P] T-006: Documentation surfaces + AGENTS.md scrub**
...
- [ ] **T-007: Drift-check CLI + local script + integration tests**
...
- [ ] **[P] T-008: Boot/join version logging taps (FR-005)**
...
- [ ] **[P] T-009: Companion spec amendments (FR-011 — same change set as implementation)**
...
- [ ] **T-010: Lockstep bump to `0.0.1` (SC-007)**
...
- [ ] **T-012: Repo-wide gates + project-state update**
