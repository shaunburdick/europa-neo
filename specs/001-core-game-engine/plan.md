...
**Branch**: `001-europa-core` | **Date**: 2026-08-21 | **Spec**: [`specs/001-core-game-engine/spec.md`](./spec.md)

**Input**: Feature specification from `specs/001-core-game-engine/spec.md` — deterministic tick-based simulation (cities, pipes, fog, combat, decay, paratroopers, guns, victory) for the Europa Neo reimplementation.
