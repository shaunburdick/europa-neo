...
**Branch**: `001-europa-core` | **Date**: 2026-08-21 | **Spec**: [`specs/004-multiplayer-networking/spec.md`](./spec.md)

**Input**: Feature specification from `specs/004-multiplayer-networking/spec.md` — server-authoritative WebSocket protocol connecting clients to running matches: command submission, per-tick state broadcast with fog-of-war filtering, delta sync, reconnection handling.
...
```text
specs/004-multiplayer-networking/
