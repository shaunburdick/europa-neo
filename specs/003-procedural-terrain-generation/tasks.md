...
**Input**: Design documents from `specs/003-procedural-terrain-generation/`
...
- [ ] T055 Run full quickstart validation against `specs/003-procedural-terrain-generation/quickstart.md` — execute Q-T01 through Q-T08 per §3 smoke REPL; confirm the acceptance criteria table in §4 maps green-to-green; flip spec status from `Draft` → `Planned` → `Implemented` in `specs/003-procedural-terrain-generation/spec.md` per AGENTS.md; update `AGENTS.md` Current state section to reflect feature 003 phase 6 done; depends on T046, T053
