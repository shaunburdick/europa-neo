...
- [x] T-029 (a11y): Add browser/axe coverage for meaningful logo names, decorative hidden/empty alt, logo-only link names, contrast, keyboard focus, compact fallback, and reduced-motion behavior.
- [x] T-030 (visual): Review actual 16/32/48/180/192/512 renderings, maskable crop, light/dark treatments, monochrome meaning, and 1200×630 safe margins in Chromium; record findings and remediate before acceptance.
...
- [x] T-035 (architect/PM): Review every acceptance criterion AC-001–AC-011, attach command output and visual/originality evidence, and obtain product-owner sign-off before merging.
