...
- [x] Review HOLD follow-up (maskable regression coupling): Assert the emitted maskable SVG transform and emblem body, then decode and measure the generated resvg PNG's non-plate pixels against the manifest safe circle. Preserve `scale(0.72)` and approved masters; do not begin T-013/T-014.
