...
The status bar also shows a small version indicator — the app version your console was built from (for example, v0.1.0) — which stays visible regardless of the match state.
