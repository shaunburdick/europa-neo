...
| <span class="europa-chip">expired</span> | The 60-second grace window elapsed while you were away — your seat is forfeited | Return to the lobby and choose a match or create one (see [Quick start](./quick-start)) |
