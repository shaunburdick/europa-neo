...
| City production | <EuropaTroopChip count="1" owner="1"></EuropaTroopChip> troop/tick until saturated | `ENGINE_CONSTANTS.productionRate` |
...
| Value | Shipped value | Constant |
| --- | --- | --- |
| Paratroop order cost | <EuropaTroopChip count="20" owner="1"></EuropaTroopChip> troops removed at source | `ENGINE_CONSTANTS.paratroopCost` (10) × 2 |
| Paratroops landed | <EuropaTroopChip count="10" owner="1"></EuropaTroopChip> troops at target | `ENGINE_CONSTANTS.paratroopCost` |
| Gun shot cost | <EuropaTroopChip count="5" owner="1"></EuropaTroopChip> troops per shot | `ENGINE_CONSTANTS.gunCost` |
| Gun damage | <EuropaTroopChip count="2" owner="2"></EuropaTroopChip> troops, everything in the target cell | `ENGINE_CONSTANTS.gunDamage` |
...
| Player 1 color | <EuropaPlayerBadge player="1"></EuropaPlayerBadge> Red `#dc2626` | `TOKENS.color.playerColor1` (`@europa/design`) |
| Player 2 color | <EuropaPlayerBadge player="2"></EuropaPlayerBadge> Blue `#2563eb` | `TOKENS.color.playerColor2` (`@europa/design`) |
| Player 3 color | <EuropaPlayerBadge player="3"></EuropaPlayerBadge> Green `#059669` | `TOKENS.color.playerColor3` (`@europa/design`) |
| Player 4 color | <EuropaPlayerBadge player="4"></EuropaPlayerBadge> Orange-gold `#d97706` | `TOKENS.color.playerColor4` (`@europa/design`) |
