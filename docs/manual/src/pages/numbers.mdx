...
| Player 1 color | <EuropaPlayerBadge player="1"></EuropaPlayerBadge> Red `#dc2626` | `DEFAULT_PLAYER_COLORS[1]` |
| Player 2 color | <EuropaPlayerBadge player="2"></EuropaPlayerBadge> Blue `#2563eb` | `DEFAULT_PLAYER_COLORS[2]` |
| Player 3 color | <EuropaPlayerBadge player="3"></EuropaPlayerBadge> Green `#059669` | `DEFAULT_PLAYER_COLORS[3]` |
| Player 4 color | <EuropaPlayerBadge player="4"></EuropaPlayerBadge> Orange-gold `#d97706` | `DEFAULT_PLAYER_COLORS[4]` |
