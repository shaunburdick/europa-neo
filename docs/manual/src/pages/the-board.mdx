...
import { EuropaElevationSwatch } from '@europa/design/components';
...
- **Downhill** pipes (toward lower cells) get a bonus: the steeper the drop, the faster the flow. <EuropaElevationSwatch elevation="20"></EuropaElevationSwatch>
- **Flat** pipes (equal elevation) flow steadily at the base rate. <EuropaElevationSwatch elevation="50"></EuropaElevationSwatch>
- **Uphill** pipes (toward higher cells) pay a handicap: the steeper the climb, the slower the flow. <EuropaElevationSwatch elevation="80"></EuropaElevationSwatch>
- **Steep uphill** pipes (a climb of 7 or more elevation steps) **stall** — they move nothing, and render as hollow triangles on the board. <EuropaElevationSwatch elevation="100"></EuropaElevationSwatch>
