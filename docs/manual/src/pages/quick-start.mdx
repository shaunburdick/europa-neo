...
Europa Neo opens at the **public lobby** (`/lobby`). This page walks you from choosing a handle to issuing your first orders. See [The public lobby](./lobby) for the complete browser guide.
