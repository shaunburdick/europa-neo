...
export type {
  ...
  World,
  CellView,
  // engine ↔ matchmaking boundary (declared in engine-to-matchmaking.ts)
  EngineSession,
  MatchInitRequest,
  MatchResultsRecord,
} from '@europa/engine';
...
// both packages without conversion noise.
export type { MatchId, SessionToken, ConnectionId } from '@europa/networking';
