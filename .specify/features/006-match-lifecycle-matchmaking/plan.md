...
**Branch**: `001-europa-core` | **Date**: 2026-08-21 | **Spec**: [`.specify/features/006-match-lifecycle-matchmaking/spec.md`](./spec.md) (v1.1)

**Input**: Feature specification from `.specify/features/006-match-lifecycle-matchmaking/spec.md` v1.1 — server-authoritative match lifecycle: display name, public/private match creation, lobby browser, shareable join links, auto-start when seats fill, results delivery, rematch, and disconnect-forfeit policy.
...
```text
.specify/features/006-match-lifecycle-matchmaking/
