...
**Branch**: `001-europa-core` | **Date**: 2026-08-24 | **Spec**: [`.specify/features/007-player-manual/spec.md`](./spec.md)

**Input**: Feature specification from `.specify/features/007-player-manual/spec.md` (v1.0) — an end-user instruction book for players as plain Markdown under `docs/manual/`, published to GitHub Pages by an official-actions workflow on merge to `main`.
