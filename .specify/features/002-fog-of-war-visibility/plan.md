...
**Branch**: `001-europa-core` | **Date**: 2026-08-21 | **Spec**: [`.specify/features/002-fog-of-war-visibility/spec.md`](./spec.md)

**Input**: Feature specification from `.specify/features/002-fog-of-war-visibility/spec.md` — per-player visibility horizon derived from troop positions; no memory of previously seen terrain; unseen areas are unknown; server never reveals hidden information to clients.
...
```text
.specify/features/002-fog-of-war-visibility/
