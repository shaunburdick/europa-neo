...
4. `specs/NNN-*/spec.md` — feature specs (source of truth for behavior)
5. `specs/NNN-*/plan.md` — per-feature architecture
6. `specs/NNN-*/tasks.md` — per-feature task lists (381 tasks total)
7. `specs/NNN-*/contracts/*.ts` — TypeScript cross-package boundaries
