...
- **Completed**:
  ...
  - **Integration wave: DONE** — full production path proven end-to-end: console UI (`?live` runtime) ⇄ real browser WebSocket client ⇄ real `createMatchServer` (ephemeral port) ⇄ matchmaking-bound engine+terrain+fog. Landed:
