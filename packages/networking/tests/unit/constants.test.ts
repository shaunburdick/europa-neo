...
describe('NETWORK_CONSTANTS', () => {
    ...
    it('stays in lockstep with the contract NETWORK_DEFAULT_CONFIG', () => {
        ...
        expect(NETWORK_CONSTANTS.defaultHeartbeatIntervalMs).toBe(NETWORK_DEFAULT_CONFIG.heartbeatIntervalMs);
        ...
        expect(NETWORK_CONSTANTS.defaultRateLimitBurstFactor).toBe(NETWORK_DEFAULT_CONFIG.rateLimitBurstFactor);
        expect(NETWORK_CONSTANTS.defaultMaxConcurrentMatches).toBe(NETWORK_DEFAULT_CONFIG.maxConcurrentMatches);
