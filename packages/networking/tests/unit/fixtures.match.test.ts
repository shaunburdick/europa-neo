...
import type { AttachPlayerRequest, DetachRequest, RegisterMatchRequest, Server, SessionToken } from '../../src/types';
...
describe('scriptedMatch', () => {
    ...
    it('rejects invalid options', () => {
        ...
        expect(() => scriptedMatch({ playerCount: 2, displayNames: ['only-one'] })).toThrow(/displayNames/);
    });
