/**
 * The machine-readable inventory for generated Europa Neo brand assets.
 *
 * Source masters are deliberately absent from this manifest. Consumers may
 * only use generated files below the package's `dist/brand` directory.
 */
...
const svgAsset = (id: BrandAssetId, path: `brand/${string}`, background: BrandBackground): BrandAsset => ({
    id,
    path,
    format: 'svg',
    width: null,
...
/** Complete consumer-facing generated inventory, sorted by stable asset ID. */
export const BRAND_MANIFEST = {
    ...
    assets: [
        ...
        { ...svgAsset('favicon', 'brand/favicon.svg', 'transparent'), purpose: 'favicon', alt: null },
        {
            id: 'favicon-ico',
...
export type BrandAssetPath = (typeof BRAND_MANIFEST.assets)[number]['path'];
