    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            >
                ...
                >
                    Build cities, lay pipelines, and command your forces in this faithful reimplementation of the
                    classic multiplayer strategy game. Play against a friend in real-time or host your own server.
                </p>
