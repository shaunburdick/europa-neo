...
describe('ZoomPanController (US5 AC-1)', () => {
    ...
    it('middle-button drag pans; dispose removes listeners', () => {
        ...
        element.dispatchEvent(new PointerEvent('pointerdown', { button: 1, clientX: 100, clientY: 100 }));
        element.dispatchEvent(new PointerEvent('pointermove', { buttons: 4, clientX: 60, clientY: 80 }));
        ...
        element.dispatchEvent(new PointerEvent('pointermove', { buttons: 4, clientX: 500, clientY: 500 }));
