...
`./src` (e.g., `specs/002-fog-of-war-visibility/contracts/`) violates `rootDir` and trips the
...
1. Update the spec file (`specs/002-fog-of-war-visibility/contracts/*.ts`) first.
