 ...
 * core game types, deterministic PRNG, and the API version constant.
 * This package has zero workspace dependencies so it always builds
 * first, resolving the engine ↔ terrain circular dependency (issue #93).
 *
