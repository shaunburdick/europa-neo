...
export interface MatchConfig {
    ...
    /**
     * Player identifiers for this match. Length ∈ [2, 4] (FR-019).
     *
     * Replaces the former `playerCount` field. The engine derives
     * player count from `playerIds.length`. Each ID is a branded
     * string generated by the server at match start (FR-020/FR-021).
     */
