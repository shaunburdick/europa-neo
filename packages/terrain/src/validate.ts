...
import type { GenerationSettings, MapStats, ValidationReport, Violation } from './contracts/terrain-types';
...
// partnerPlayer is used above for INV-9 validation (see city-symmetry.ts).
