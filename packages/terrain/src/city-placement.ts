 ...
 * @param owner     The 1-based dense numeric placement slot to assign
 *                  to these cities. Terrain is identity-agnostic
 *                  (issue #74, FR-011): this is never a canonical
 *                  `PlayerId`; the caller maps slots to IDs.
