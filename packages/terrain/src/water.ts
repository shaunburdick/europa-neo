 ...
 *          of the input.
 */
export function extractWater(elev: Uint8Array, width: number, height: number, waterRatio: number): Uint8Array {
 ...
 * @internal
 */
export function _extractWater(elev: Uint8Array, width: number, height: number, waterRatio: number): Uint8Array {
