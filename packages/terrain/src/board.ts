 ...
 */
export function buildBoard(elev: Uint8Array, water: Uint8Array, width: number, height: number): Board {
 ...
 */
export function assertBoardMatchesConfig(board: Readonly<Board>, config: Readonly<MatchConfig>): void {
    // Square shape.
