...
/** Every workspace package the real repository guards (core, engine, terrain, fog, networking, matchmaking, console, version, design, logging). */
const EXPECTED_WORKSPACE_PACKAGES = 10;
...
describe('drift check against the REAL repository (positive lockstep proof)', () => {
    it('gathered sources cover every guarded surface kind with ten workspace packages', async () => {
